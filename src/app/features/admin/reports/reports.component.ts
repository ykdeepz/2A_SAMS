...
@Component({
  ...
  template: `<div class="layout"><app-sidebar [currentUser]="currentUser" (logout)="onLogout()"></app-sidebar><div class="main-content"><div class="header"><h1>Reports</h1></div><div class="content"><p>System reports</p></div></div></div>`,
