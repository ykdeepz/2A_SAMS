...
@Component({
  ...
  template: `<div class="layout"><app-sidebar [currentUser]="currentUser" (logout)="onLogout()"></app-sidebar><div class="main-content"><div class="header"><h1>Manage Subjects</h1></div><div class="content"><p>Subject management</p></div></div></div>`,
