...
@Component({
  ...
  template: `<div class="layout"><app-sidebar [currentUser]="currentUser" (logout)="onLogout()"></app-sidebar><div class="main-content"><div class="header"><h1>Child's Attendance</h1></div><div class="content"><p>Attendance records</p></div></div></div>`,
