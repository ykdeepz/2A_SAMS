...
@Component({
  ...
  template: `<div class="layout"><app-sidebar [currentUser]="currentUser" (logout)="onLogout()"></app-sidebar><div class="main-content"><div class="header"><h1>Child's Grades</h1></div><div class="content"><p>Grade information</p></div></div></div>`,
