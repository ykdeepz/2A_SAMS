...
@Component({
  ...
  template: `
    <div class="layout">
      ...
      <div class="main-content"><div class="header"><h1>Child's Dashboard</h1></div><div class="content"><p>Hello {{ currentUser?.name }}, here's your child's information</p></div></div>
    </div>
  `,
